...
suite.runTest({
	...
	await executeInWorker('/tests/workers/perf-async-test-a.js', {
		...
		PRIMITIVE_DEEP_MUTATION_TRSHLD: 0.002,
		PRIMITIVE_DEEP_ADDITION_TRSHLD: 0.002,
		PRIMITIVE_DEEP_DELETION_TRSHLD: 0.002
	});
});
...
suite.runTest({
	...
	return executeInWorker('/tests/workers/perf-async-test-b.js', {
		...
		ARRAY_PUSH_TRSHLD: 0.02,
		ARRAY_MUTATION_TRSHLD: 0.02,
		ARRAY_POP_TRSHLD: 0.002
	});
});
